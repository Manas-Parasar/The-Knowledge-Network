...
const Home = () => {
  ...
  return (
    ...
    >
      {/* Hero Section */}
      <motion.section
        className="bg-white/90 shadow-lg rounded-2xl py-20 w-full mt-8"
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/schools"
              className="bg-accent text-primary font-semibold px-8 py-3 rounded-lg shadow-lg transition-all duration-300 transform hover:scale-105 hover:bg-yellow-400"
            >
              Explore Schools
            </Link>
            <Link
              to="/events"
              className="bg-secondary text-white font-semibold px-8 py-3 rounded-lg shadow-lg transition-all duration-300 transform hover:scale-105 hover:bg-green-600"
            >
              Join Events
            </Link>
          </div>
      ...
      {/* Mission Section */}
      <motion.section
        className="py-16 bg-white/90 shadow-lg rounded-2xl w-full"
      ...
      {/* Quick Links Section */}
      <motion.section
        className="py-16 bg-white/90 shadow-lg rounded-2xl w-full mt-10 mb-20"
        initial={{ opacity: 0, y: 30 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.6, delay: 0.5 }}
      >
        <div className="flex flex-wrap justify-center gap-8 items-center mx-auto max-w-7xl px-6 py-10">
          <h2 className="text-3xl md:text-4xl font-bold text-center text-primary mb-12 w-full">
          ...
          <div className="flex flex-wrap justify-center gap-8 items-stretch w-full">
            ...
            >
              <Link
                to="/schools"
                className="block bg-gradient-to-br from-white/90 to-white/95 p-6 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 text-center border-t-4 border-primary hover:border-primary-600 transform hover:scale-105 h-full"
              >
            ...
            >
              <Link
                to="/events"
                className="block bg-gradient-to-br from-white/90 to-white/95 p-6 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 text-center border-t-4 border-secondary hover:border-secondary-600 transform hover:scale-105 h-full"
              >
            ...
            >
              <Link
                to="/donations"
                className="block bg-gradient-to-br from-white/90 to-white/95 p-6 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 text-center border-t-4 border-accent hover:border-yellow-500 transform hover:scale-105 h-full"
              >

    ...
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-8">
        ...
        <button
          ...
          className="bg-primary text-white px-4 py-2 rounded-lg shadow-md hover:bg-accent transition-colors"
        >
          Add Slot
        </button>
      </div>
              ...
              >
                ...
                <div className="flex flex-wrap gap-2">
                  <button
                    ...
                    className="bg-secondary text-white px-3 py-2 text-sm rounded-lg shadow-sm hover:bg-accent transition-colors"
                  >
                    Edit
                  </button>
                  <button
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="flex space-x-2">
                ...
                <button
                  ...
                  className="bg-secondary text-white px-4 py-2 rounded-lg shadow-md hover:bg-accent transition-colors"
                >
                  Cancel
                </button>
              </div>

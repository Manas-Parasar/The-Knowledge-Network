  ...
  return (
    <AnimatePresence mode="wait">
      <Routes>
        ...
        <Route path=":route" element={<DynamicTab />} />
    ...
    <ErrorBoundary>
      <ToastProvider>
        <AuthProvider>
          <Router>
            <motion.div
              className="App w-full min-h-screen text-gray-900 flex flex-col"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ duration: 0.3 }}
            >
              <Navbar />
              <main className="w-full flex-1 text-gray-900 mx-auto px-4 md:px-8">
                <AppRoutes />
              </main>
              <ConditionalFooter />
            </motion.div>

...
import { addSlot } from "../../firebase/slots";
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {schools.map((school) => (
          <div
            key={school.id}
            className="bg-white shadow-md rounded-xl p-6 flex flex-col items-center justify-between min-h-[300px]"
          >
            ...
            <div className="flex flex-wrap justify-center gap-3 mt-4 w-full">
              ...
              <button
                onClick={() => alert("View Slots functionality coming soon")}
                className="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 flex-shrink-0"
              >
                View Slots
              </button>
              <button
                onClick={() => handleEdit(school)}
                className="bg-primary text-white px-3 py-2 text-sm rounded-lg shadow-sm hover:bg-accent transition-colors flex-shrink-0"
              >
                Edit
              </button>
              <button
                onClick={() => handleDelete(school.id)}
                className="bg-red-500 text-white px-3 py-2 text-sm rounded-lg shadow-sm hover:bg-red-600 transition-colors flex-shrink-0"
              >
                Delete
              </button>
            </div>
      ...
      {showSlotModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-md">
            <h2 className="text-2xl font-bold mb-4">
              Add Slot for {selectedSchoolForSlot?.name}
            </h2>

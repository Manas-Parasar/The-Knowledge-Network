          ...
          >
            ...
            <div className="flex flex-wrap gap-1">
              <button
                ...
                className="bg-primary-500 text-white px-2 py-1 text-xs rounded-md shadow-sm hover:bg-accent transition-colors"
              >
                Edit
              </button>
              <button
                onClick={() => handleDelete(school.id)}
                className="bg-red-500 text-white px-2 py-1 text-xs rounded-md shadow-sm hover:bg-red-600 transition-colors"
              >
                Delete
              </button>
            </div>

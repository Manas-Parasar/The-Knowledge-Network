          ...
          >
            ...
            <div className="flex flex-wrap gap-2">
              <button
                ...
                className="bg-primary-500 text-white px-3 py-2 text-sm rounded-lg shadow-sm hover:bg-accent transition-colors"
              >
                Edit
              </button>
              <button
                onClick={() => setFeaturedClub(club.id)}
                className="bg-yellow-500 text-white px-3 py-2 text-sm rounded-lg shadow-sm hover:bg-yellow-600 transition-colors"
              >
                Feature
              </button>
              <button

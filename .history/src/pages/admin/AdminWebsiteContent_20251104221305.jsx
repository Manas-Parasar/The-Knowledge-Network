...
// Simple WYSIWYG-like editor component
const SimpleTextEditor = ({ value, onChange, placeholder }) => {
  ...
  const insertLink = () => insertText("[Link Text](https://example.com)", "");
  const insertList = () => insertText("- ", "");
  const insertLineBreak = () => insertText("\n\n", "");
  ...
  return (
    <div className="border border-gray-300 rounded-lg">
      ...
      <textarea
        ...
        className="w-full px-3 py-2 border-0 rounded-b-lg focus:outline-none focus:ring-2 focus:ring-primary resize-vertical font-mono text-sm"
        rows="10"
        placeholder={placeholder}
      />
      <div className="px-3 py-2 text-xs text-gray-500 bg-gray-50 border-t border-gray-200">
        💡 <strong>Easy Formatting:</strong> Click buttons above or type:
        **bold**, *italic*, # Heading, - List item, [Link Text](url)
      </div>
    </div>
  );
};
            ...
            <form onSubmit={handleTabSubmit}>
              ...
              <div className="mb-4">
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    setTabFormData({ ...tabFormData, content: e.target.value })
                  }
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
                  rows="4"
                />

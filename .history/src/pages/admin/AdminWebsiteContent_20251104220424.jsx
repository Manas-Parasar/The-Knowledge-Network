  ...
  return (
    <div className="border border-gray-300 rounded-lg">
      ...
      <textarea
        ...
        className="w-full px-3 py-2 border-0 rounded-b-lg focus:outline-none focus:ring-2 focus:ring-primary resize-vertical"
        rows="8"
        placeholder={placeholder}
      />
      <div className="px-3 py-2 text-xs text-gray-500 bg-gray-50 border-t border-gray-200">
        💡 Tip: Use the buttons above to format text, or type directly.
        **bold**, *italic*, # headings, - lists, [text](url) links
      </div>
    </div>
  );
};

...
const Schools = () => {
  ...
  const handleSignupSubmit = async (e) => {
    e.preventDefault();
    if (!signupFormData.childName.trim()) {
      setFormErrors({ general: "Child's name is required" });
      return;
    }

    setProcessing(true);
    try {
      const userName = `${signupFormData.childName}${
                              ...
                              <div className="ml-4">
                                {isSignedUp ? (
                                  ...
                                  <button
                                    ...
                                    className="bg-green-500 text-white px-4 py-2 rounded-lg shadow-sm hover:bg-green-600 transition-colors disabled:opacity-50"
                                    disabled={processing}
                                  >
                                    {processing ? "..." : "Sign Up"}
                                  </button>
          ...
          <div className="bg-white rounded-lg p-6 w-full max-w-md">
            ...
            <form onSubmit={handleSignupSubmit}>
              <div className="mb-4">
                ...
                <input
                  type="text"
                  value={signupFormData.childName}
                  onChange={(e) =>
                    setSignupFormData({
                      ...signupFormData,

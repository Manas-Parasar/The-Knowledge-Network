...
const Home = () => {
  ...
  return (
    ...
    >
      {/* Hero Section */}
      <motion.section
        className="bg-white/90 shadow-lg rounded-2xl py-20 w-full mx-6 md:mx-10 mt-8"
      ...
      {/* Quick Links Section */}
      <motion.section
        className="py-16 bg-white/90 shadow-lg rounded-2xl w-full mx-6 md:mx-10 mt-10 mb-20"
        initial={{ opacity: 0, y: 30 }}
        animate={{ opacity: 1, y: 0 }}

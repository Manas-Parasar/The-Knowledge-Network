          ...
          <div className="bg-white p-6 rounded-lg w-full max-w-sm mx-4">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="bg-primary-500 text-white px-4 py-2 rounded hover:bg-accent"
              >
                Delete
              </button>
              <button
          ...
          >
            ...
            <div className="flex gap-2 mb-2">
              <a
                ...
                className="inline-block bg-primary-500 text-white px-4 py-2 rounded hover:bg-accent transition-colors"
              >
                View Resource
              </a>
                ...
                <div className="mt-2">
                  ...
                  {currentUser && (
                    ...
                    >
                      ...
                      <button
                        type="submit"
                        className="mt-2 bg-primary-500 text-white px-4 py-2 rounded hover:bg-accent"
                      >
                        Submit Comment
                      </button>
                    </form>

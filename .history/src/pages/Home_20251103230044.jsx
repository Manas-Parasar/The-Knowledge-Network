...
const Home = () => {
  ...
  return (
    <div className="w-full">
      {/* Hero Section */}
      <section className="bg-white/90 shadow-lg rounded-2xl py-20 w-full mx-6 md:mx-10">
      ...
      {/* Mission Section */}
      <section className="py-16 bg-white/90 shadow-lg rounded-2xl w-full mx-6 md:mx-10">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div>
              <Link
                to="/schools"
                className="block bg-white/90 p-6 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 text-center border-t-4 border-primary hover:border-primary-600"
              >
            ...
            <div>
              <Link
                to="/events"
                className="block bg-white/90 p-6 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 text-center border-t-4 border-secondary hover:border-secondary-600"
              >
            ...
            <div>
              <Link
                to="/donations"
                className="block bg-white/90 p-6 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 text-center border-t-4 border-accent hover:border-yellow-500"
              >

  ...
  return (
    <div className="container mx-auto p-4">
      <div className="flex justify-between items-center mb-4">
        <h1 className="text-2xl font-bold text-accent">Resources</h1>
        {currentUser && (
          <button
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="bg-primary-500 text-white px-4 py-2 rounded-lg shadow-sm hover:bg-accent disabled:opacity-50"
                >
                  {isSubmitting
                    ? "Saving..."
                    : editingResource
                ...
                <button
                  type="button"
                  onClick={closeModal}
                  className="bg-primary-500 text-white px-4 py-2 rounded-lg shadow-sm hover:bg-accent"
                >
                  Cancel
                </button>
              </div>
          ...
          >
            ...
            <div className="flex gap-2 mb-2">
              <a
                ...
                className="inline-block bg-primary-500 text-white px-4 py-2 rounded-lg shadow-sm hover:bg-accent transition-colors"
              >
                View Resource
              </a>
                ...
                <div className="mt-2">
                  {loadingComments[resource.id] ? (
                    ...
                    <div className="space-y-2">
                      {comments[resource.id].map((comment) => (
                        <div
                          key={comment.id}
                          className="bg-gray-50 p-2 rounded-lg shadow-sm text-sm"
                        >
                  ...
                  {currentUser && (
                    ...
                    >
                      ...
                      <button
                        type="submit"
                        className="mt-2 bg-primary-500 text-white px-4 py-2 rounded-lg shadow-sm hover:bg-accent"
                      >
                        Submit Comment
                      </button>
                    </form>

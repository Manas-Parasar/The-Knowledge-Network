...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white/95 backdrop-blur-md text-gray-900 shadow-lg rounded-2xl sticky top-0 z-50 mx-6 md:mx-10 mt-6 md:mt-10">
      <div className="w-full px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden lg:flex items-center space-x-4">
            ...
            <Link
              to="/admin-dashboard"
              className="px-3 py-2 rounded-lg text-sm font-medium hover:bg-yellow-400 transition-colors duration-200 shadow-sm"
            >
              Admin
            </Link>
            <Link
      ...
      {isOpen && (
        <div className="lg:hidden bg-white/90 shadow-lg rounded-2xl">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <Link
              to="/admin-dashboard"
              className="block w-full text-left px-3 py-2 rounded-lg text-base font-medium hover:bg-yellow-400 transition-colors duration-200 shadow-sm"
              onClick={() => setIsOpen(false)}
            >
              Admin
            </Link>
              ...
              <div className="px-3 py-2">
                ...
                {adminLinks.map((link) => (
                  <Link
                    key={link.path}
                    to={link.path}
                    className="block px-3 py-2 rounded-lg text-base font-medium hover:bg-yellow-400 transition-colors duration-200 shadow-sm"
                    onClick={() => setIsOpen(false)}
                  >
                    {link.name}
                  </Link>

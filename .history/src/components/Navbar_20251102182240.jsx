...
const Navbar = () => {
  ...
  return (
    <nav className="bg-primary-600 text-white shadow-lg rounded-b-lg">
      ...
      {isOpen && (
        <div className="md:hidden bg-primary-600">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <button
              onClick={handleLogout}
              className="block w-full text-left px-3 py-2 rounded-md text-base font-medium hover:bg-accent transition-colors duration-200"
            >
              Logout
            </button>
          </div>

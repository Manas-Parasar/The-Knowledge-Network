  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-blue-600 shadow-md"></div>
      </div>
    );
  }
            ...
            <div className="text-center">
              ...
              <div className="mt-6">
                <button
                  ...
                  className="text-sm text-primary-500 hover:text-accent rounded-lg px-2 py-1 shadow-sm"
                >
                  Change selection
                </button>
              </div>
              ...
              <div className="space-y-3">
                {schools.map((school) => (
                  <button
                    ...
                    disabled={saving}
                    className="w-full text-left px-4 py-3 border border-gray-300 rounded-lg shadow-sm bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 disabled:opacity-50 disabled:cursor-not-allowed"
                  >

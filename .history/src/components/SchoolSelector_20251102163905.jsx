...
const SchoolSelector = ({ onSchoolSelected }) => {
  const { currentUser, setSelectedSchool, userRole } = useContext(AuthContext);
              ...
              <div className="space-y-3">
                {schools.map((school) => (
                  <button
                    ...
                    disabled={saving}
                    className="w-full text-left px-4 py-3 border border-gray-300 rounded-md shadow-sm bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed"
                  >

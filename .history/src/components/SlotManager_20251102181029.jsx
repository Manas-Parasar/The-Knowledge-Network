    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white p-6 rounded-lg w-full max-w-4xl max-h-[90vh] overflow-y-auto">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold">Manage Slots - {schoolName}</h2>
          <button
            onClick={onClose}
                  ...
                  {canEditOrDelete(slot) && (
                    <div className="flex space-x-2 ml-4">
                      <button
                        ...
                        className="bg-primary-500 text-white px-3 py-1 rounded hover:bg-accent transition-colors text-sm"
                      >
                        Edit
                      </button>
                      <button
            ...
            <div className="bg-white p-6 rounded-lg w-full max-w-md max-h-[90vh] overflow-y-auto">
                    ...
                    {showManageSignups.signedUpUsers.map((user, index) => (
                      ...
                      >
                        ...
                        <button
                          ...
                          className="bg-primary-500 text-white px-2 py-1 rounded hover:bg-accent transition-colors text-sm"
                        >
                          Remove
                        </button>
                      </li>
              ...
              <div className="mb-4">
                ...
                <button
                  ...
                  className="bg-primary-500 text-white px-4 py-2 rounded hover:bg-accent transition-colors disabled:bg-gray-400"
                >
                  Add User
                </button>
              </div>
